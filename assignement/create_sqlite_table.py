#Write a program to create a table in sqlite database and insert some rows into it.---
#import sqlite3---
import mysql.connector
#creating database/connect---
join = mysql.connector.connect(user='root', password='bsdu@123',host='localhost')
#creating cursor---
c=join.cursor()
